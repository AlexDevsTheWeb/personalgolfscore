...
import { IAllRoundsTotals, IPuttsStatistics, IRoundChipPitchTotals, IRoundFwAndIronsTotals, IRoundInside100MtTotals, IRoundTeeShotsTotals, IRoundTotals } from "../types/roundTotals.types";
...
export const initialStateRoundsTotals: IAllRoundsTotals = {
  roundsTotals: [
    {
      playerID: 'playerID',
      mainData: {
