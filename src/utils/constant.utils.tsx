...
import { IPuttsStatistics, IRoundChipPitchTotals, IRoundFwAndIronsTotals, IRoundInside100MtTotals, IRoundTeeShotsTotals, IRoundTotals, IRoundsTotals } from "../types/roundTotals.types";
...
export const initialStateRoundsTotals: IRoundsTotals = {
  playerID: 'playerID',
  totals: [
    {
      mainData: {
